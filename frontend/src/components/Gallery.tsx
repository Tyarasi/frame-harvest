...
import { BoundingBoxIcon, ChevronLeftIcon, ChevronRightIcon, CropIcon, TrashIcon } from './icons'
...
export function Gallery({ projectId, cameras, counts, focusLabel, onResetAll }: Props) {
      ...
      <div className="mb-3 flex flex-wrap items-center justify-end gap-3">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Hapus semua gambar frame dan crop object di semua sample"
