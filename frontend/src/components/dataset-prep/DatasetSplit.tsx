...
export function DatasetSplit({ projectId }: Props) {
  ...
  // ADA/TIDAKNYA split saat ini (bukan cuma "baru saja di-generate di sesi
  // ini") — dipakai buat nentuin tombol Ekspor muncul walau user baru buka
  // halaman ini lagi setelah split dibuat kemarin, bukan cuma abis klik Generate
  ...
  useEffect(reloadSplitSummary, [projectId])
      ...
      <div className="mb-4 flex flex-wrap items-end gap-3">
        ...
        {hasSplit && (
          <>
            ...
            <ActionBadge kind="safe" label="Baca saja, tidak mengubah apapun" />
            <a
              href={api.splitExportUrl(projectId)}
